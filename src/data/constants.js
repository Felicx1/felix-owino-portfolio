export const Bio = {
  ...
  description:
    "I am well-groomed and assertive individual who has all of the all the physical and mental capabilities. I am a team player, hardworking and flexible enough to adopt to changes, receptive to new ideas and ready to learn new skills. Have high discipline in time management and social aspects both at work and community at large. ",
  github: "https://github.com/Felicx1",
  resume:
...
export const skills = [
  {
    ...
    skills: [
...

      {
       ...
       name: "Vue Js",
       image:
       "data:image/png;base64,"
      },
      {
        name: "Redux",
        image:
...
export const experiences = [
  ...
  },
  {
    ...
    company: "Phynix Media Limited",
    date: "Jan  2022 - Dec 2022",
    desc: " I excelled in optimizing both development processes and end-user experiences. Spearheading DevOps initiatives, I streamlined deployment pipelines, implemented CI/CD practices, and automated infrastructure management, leading to significant improvements in efficiency and reliability. On the full stack front, I crafted intuitive user interfaces and robust backend systems, ensuring seamless functionality and high performance across Phynix Media's platforms. Leveraging a combination of technologies like React Js, Node.js, and Docker, I orchestrated the development of scalable, maintainable applications that met the company's evolving needs. Additionally, I played a key role in fostering a culture of collaboration and innovation within the team, driving forward Phynix Media's mission with passion and dedication",
    skills: [
      "Docker",
      "Terraform",
      "AWS",
  ...
  },
  {
    ...
    company: "Comprite Kenya Limited",
    date: "Jul 2018 - Dec 2021",
    desc: "I contributed to the company's success by developing innovative solutions and driving technological advancements. Collaborating closely with cross-functional teams, I designed and implemented robust software systems that met the company's requirements and exceeded client expectations. Utilizing a diverse skill set encompassing programming languages like Python, Php,laravel,  Vue Js, React Js,JavaScript, I tackled complex challenges and delivered scalable, efficient applications. Whether it was enhancing existing products, troubleshooting issues, or pioneering new features, I approached each task with meticulous attention to detail and a commitment to excellence. My contributions helped Comprite Kenya Limited maintain its position as a leader in the industry, continuously pushing the boundaries of what's possible in software development.",
    skills: [
      "Android",
      "Java",
      "Kotlin",
  ...
  },
  {
    id: 3,
    img: "",
    role: "Web Apps Developer Intern",
    company: "Shalom IT Center",
    date: "April 2017 - July 2018",
    desc: "During my tenure as a Web Apps Developer Intern at Shalom IT Center, I gained valuable hands-on experience while contributing to various projects and initiatives. Under the guidance of seasoned professionals, I actively participated in the development and maintenance of web applications, honing my skills in front-end and back-end technologies. Through tasks such as creating user interfaces, implementing features, and troubleshooting issues, I developed a solid understanding of the software development lifecycle. Additionally, I enthusiastically embraced opportunities to learn new technologies and methodologies, making meaningful contributions to the team's objectives. My time at Shalom IT Center provided me with a strong foundation for my future career in web development and instilled in me a passion for continuous learning and growth.",
    skills: [
      "ReactJS",
      "Redux",
      "NodeJs",
...
export const education = [
  {
    ...
    date: "Sept 2014 - Sep 2018",
    grade: "2nd Class Honours Upper Division",
    desc: "I embarked on a journey to earn a Bachelor's degree in Computer Science, successfully completing four semesters of rigorous study. Throughout my academic pursuits, I delved into diverse subjects such as Data Structures, Algorithms, Object-Oriented Programming, Database Management Systems, Operating Systems, and Computer Networks, among other relevant courses.",
